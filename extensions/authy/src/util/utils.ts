...
export function decryptSeed(encryptedSeed: string, salt: string, password: string, keyDerivationIterations: number) {
  const iterations = keyDerivationIterations ?? 1000;
